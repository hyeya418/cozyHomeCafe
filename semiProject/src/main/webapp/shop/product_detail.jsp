    ...
    <main>
		<div id="product_box">
			<table>
				...
				<tr>
					<td><img src="${path}/shop/images/${dto.filename}" width="300px" height="300px" style="border-radius: 20px;"></td>
					<td align="center">
						<table style="line-height: 30px; margin-left: 20px;">
							...
							<tr>
								...
								<td style="font-size: 16px;"><fmt:formatNumber value="${dto.price}" pattern="#,###,###"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
								<td colspan="2">
									<form name="form1" method="post" action="${path}/cart_servlet/insert.do">
										...
										<select name="amount" class="form-select" style="width: 60px; display: inline;">
											<c:forEach begin="1" end="10" var="i">
											<option value="${i}">${i}</option>
											</c:forEach>
										</select>&nbsp;개
										<button type="submit" id="btnCart" class="btn btn-primary">장바구니에 담기</button>
									</form>
								</td>
							</tr>
						</table>
