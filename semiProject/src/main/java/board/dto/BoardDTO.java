...
public class BoardDTO {
	...
	private String ext; //첨부파일의 확장자명, 테이블에는 없음
	private String show;
	...
	public String toString() {
		return "BoardDTO [num=" + num + ", writer=" + writer + ", subject=" + subject + ", passwd=" + passwd
				...
				+ ", re_level=" + re_level + ", content=" + content + ", comment_count=" + comment_count + ", filename="
				+ filename + ", filesize=" + filesize + ", ext=" + ext + ", show=" + show + "]";
	}
}
